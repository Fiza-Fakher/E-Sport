...
function Form() {
  return (
    <>
      <main className="bg-black flex justify-center items-center flex-col text-white h-[500px]">
        ...
        <form className="w-full max-w-4xl">
          <div className="flex flex-col md:flex-row gap-4 mb-4">
            <input
              type="text"
              placeholder="Name"
              className="flex-1 px-4 py-2 bg-black text-white border-2 border-gray-500 focus:outline-none "
            />
            <input
              type="email"
              placeholder="Email"
          ...
          <textarea
            placeholder="Message"
            rows="5"
            className="w-full px-4 py-2 bg-black text-white border-2 border-gray-500  mb-6 focus:outline-none"
          ></textarea>
