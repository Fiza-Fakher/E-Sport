...
function Hero() {
  ...
  return (
    <div className="relative">
      <img src="about_bg.jpg" alt="Background Image" className="w-full min-h-[600px]" />

      <div className="absolute top-0 left-0 z-10 w-full">
        <Navbar />
        <div className="flex">
          {/* icnons */}
          <div className="md:flex flex-col mt-[100px] pl-[30px] hidden">
          ...
          <div className="mt-20 ml-24">
            ...
            <button className="w-[190px] h-[45px] border flex justify-center items-center mt-10 text-white font-bold text-lg bg-[#211A1A] border-[#211A1A]">
              ...
              Home <ArrowRightIcon className="ml-2 mr-2 text-xl font-bold"  /> About
            </button>
          </div>
        </div>
      </div>
