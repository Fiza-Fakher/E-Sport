      ...
      <div className="absolute top-0 left-0 z-10 w-full">
        ...
        <div className="flex">
          ...
          <div className="mt-20 ml-24">
            ...
            <button className="w-[390px] h-[45px] border flex justify-center items-center mt-10 text-white font-bold text-lg bg-[#211A1A] border-[#211A1A]">
              Home <ArrowRightIcon className="ml-2 mr-2 text-xl font-bold" />
              Battle Field - 4 Tournament
            </button>
          </div>
        </div>
      </div>
