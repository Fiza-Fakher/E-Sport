...
function Banner3() {
  return (
    <>
      <main className="flex justify-center items-center flex-col bg-yellow-800 pt-8 h-[450px] pb-4">
        ...
        <p className="flex flex-col text-white text-lg font-serif flex-wrap justify-center items-center w-[500px] text-center">
